...
export namespace ListInteractionsRequestBody$ {
    export const inboundSchema: z.ZodType<ListInteractionsRequestBody, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListInteractionsRequestBody> = z
        .object({
...
export namespace ListInteractionsResponse$ {
    export const inboundSchema: z.ZodType<ListInteractionsResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListInteractionsResponse> = z
        .object({
